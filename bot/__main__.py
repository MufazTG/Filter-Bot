...
if START_IMG is None:
    img = "https://telegra.ph/file/d32115e6f48883e5c17c4.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🔊 Update Channel 🔊",url="t.me/bx_botz),InlineKeyboardButton(text="Master 😇",url="https://t.me/Mufaz123")]]
    keyboard += [[InlineKeyboardButton(text="♻️ Connect Group", callback_data="main_connect"),InlineKeyboardButton(text="⚙️Help",url=",callback_data="help_back")]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="☎️ Contact Creator",url="https://t.me/Mufaz123")]]))
        return
